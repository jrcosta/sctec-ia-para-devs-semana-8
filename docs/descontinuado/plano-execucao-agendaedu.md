...
O AgendaEdu sera uma web app de agenda escolar para cadastrar compromissos, listar e filtrar registros e gerar um plano de prioridades. A solucao sera implementada com frontend Next.js, backend FastAPI e armazenamento em memoria ou arquivo JSON simples.
...
- `docs/prompts/05-frontend-nextjs.md`
