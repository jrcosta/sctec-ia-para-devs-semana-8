...
```text
Contexto:
O AgendaEdu sera uma web app com frontend Next.js, backend FastAPI e armazenamento em memoria ou arquivo JSON simples. A aplicacao precisa ser demonstravel, testavel e documentada. O projeto exige diagramas, decisoes arquiteturais e evidencias do uso de IA.
